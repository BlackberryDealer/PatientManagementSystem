...
│       ├── navbar.html.tera
│       └── footer.html.tera
├── tests/                   # Integration test suite (188 tests incl. unit tests)
...
│   ├── test_appointments.rs # Appointment booking + room override + calendar view (30 tests)
...
### Test Coverage (188 tests, 9 suites)
